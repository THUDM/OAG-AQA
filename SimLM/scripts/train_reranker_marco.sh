...
# LOCAL_RANK=2,4 CUDA_VISIBLE_DEVICES=2,4 python -u -m torch.distributed.launch --nproc_per_node 2 --use-env src/train_cross_encoder.py \
# deepspeed --include localhost:2,4 src/train_cross_encoder.py --deepspeed ds_config.json \
CUDA_VISIBLE_DEVICES=2 python src/train_cross_encoder.py \
